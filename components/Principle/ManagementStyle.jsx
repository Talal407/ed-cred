    ...
    return (
        <div className="lg:w-5xl w-s bg-white p-4 ">
            ...
            <div className="lg:py-2 ">
                <p className="font-bold text-md lg:py-4 py-2 text-[#2D2D2D]">
                    Management style
                </p>
                <p className=" text-sm  text-[#676767]">
                    Does this Principal value teachers as leaders and use teacher input to make real changes? Does he/she have a clear vision for the school and motivate staff by example? Feel free to expand on these points.
                </p>
            </div>
            <textarea
            ...
            <div className="lg:py-2">
                ...
                <p className=" text-sm  text-[#676767]">
                    Are teachers supported in issues involving parents & students? What about issues between staff? Is academic integrity respected by this Principal, or are teachers told what to teach & encouraged to "assist" students in passing with good grades?
                </p>
            </div>
            <textarea
                className="w-full h-32 p-3 border rounded-md"
            ...
            <div className="lg:py-2">
                ...
                <p className="text-sm  text-[#676767]">
                    Was this Principal involved in the hiring process? Did you interview with him/her? Describe the process. Would you recommend a colleague work for this Principal?
                </p>
            </div>
            <textarea
                className="w-full h-32 p-3 border rounded-md"
