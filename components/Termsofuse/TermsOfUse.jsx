...
const TermsOFUse = () => {
    return (
        ...
        <div className="lg:w-screen w-auto lg:my-25 my-10 lg:px-60 px-6 ">
            <p className='lg:text-base text-sm text-[#686C70] lg:my-3 my-0 '>
                Effective Date: <strong>February 12, 2025</strong>
            </p>
            <p className=' lg:text-base text-sm text-[#686C70] lg:my-3 my-2'>
            ...
            <h2 className=" lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2 ">
                General Terms
            </h2>
            <p className=' lg:text-base text-sm text-[#686C70]'>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Submission Guidelines</h2>
            <ul className=" lg:text-base text-sm lg:space-y-2 space-y-1 list-disc list-inside text-[#686C70]">
                <li>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Moderation of Reviews</h2>
            <ul className="list-disc list-inside lg:text-base text-sm lg:space-y-2 space-y-1 text-[#686C70]">
                <li>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Verified Claims</h2>
            <ul className="list-disc list-inside lg:text-base text-sm lg:space-y-2 space-y-1 text-[#686C70]">
                <li>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Dispute of Claims</h2>
            <ul className="list-disc list-inside lg:text-base text-sm lg:space-y-2 space-y-1 text-[#686C70]">
                <li>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Limitation of Liability</h2>
            <ul className="list-disc list-inside lg:text-base text-sm lg:space-y-2 space-y-1 text-[#686C70]">
                <li>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Privacy</h2>
            <ul className="list-disc list-inside lg:text-base text-sm lg:space-y-2 space-y-1 text-[#686C70]">
                <li>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">User Conduct</h2>
            <ul className="list-disc list-inside lg:text-base text-sm lg:space-y-2 space-y-1 text-[#686C70]">
                <li>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Changes to Terms</h2>
            <ul className="list-disc list-inside lg:text-base text-sm  space-y-2 text-[#686C70]">
                <p>
            ...
            <h2 className="lg:text-2xl text-[#1C2022] text-base font-semibold lg:my-3 my-2">Contact Information</h2>
            <ul className="list-disc list-inside lg:text-base text-sm space-y-2 text-[#686C70]">
                <p>
